...
class EditItem extends Component {
	...
	_groups = [];																// elenco elementi (options) del dropdown gruppi/ruoli 
		...
		return (
			<>
				...
				<div className={classFirstName}>
					<TextInput className="input-large" name="firstName" placeholder={this._labels.firstName} value={firstName} onChange={this.handleInputChange} required />
				</div>
				...
				<div className={classGroups}>
					<Select className="select-large" name="group" value={selectedGroup} onChange={this.handleInputChange}>
						{this._groups}
					</Select>
				</div>
