	...
	render() {
		...
		return (
			<Fragment key={`table-row-${index}`} >
				...
				<td className="cell-std">{firstName}</td>																{/* Cognome */}			
				<td className="cell-std">{lastName}</td>																{/* Nome */}
				<td className="cell-std bold">{userName}</td>															{/* Username */}
				<td className="cell-std textCenter">																	{/* Pulsante "Attivo" */}
					<ButtonData className="btn btn-std btn-midGrey" data={value} onClick = {this.props.onActive } >
						{active}
					</ButtonData>
				</td>
				<td className="cell-std textCenter">{creation_date}</td>												{/* Data di creazione */}				
				<td className="cell-std">{this._labels.groups[code]}</td>												{/* Ruolo */}				
				<td className="cell-std">																				{/* Pulsante "Modifica" */}
					<ButtonData className={editbtn_classname} data={id} onClick={this.props.onEdit} >
						{this._labels.update}
					</ButtonData>
				</td>
				<td className="cell-std">																				{/* Pulsante "Elimina" */}
